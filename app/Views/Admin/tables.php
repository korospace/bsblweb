	...
	<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
		<div class="sidenav-header">
			...
			<a class="navbar-brand m-0" target="_blank">
				...
				<span class="ms-1 font-weight-bold">Table Nasabah</span>
			</a>
		</div>
								...
								<table class="table align-items-center mb-0">
									<thead>
										<tr>
											...
											<th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID Number
											</th>
									...
									<tbody>
										<tr>
											...
											<td class="align-middle text-center text-sm">
												<span class="text-xs font-weight-bold"> Jl. Ciledug Raya, RT.10/RW.2, Petukangan Utara, Kec. Pesanggrahan, Kota Jakarta Selatan </span>
											</td>
											<td class="align-middle text-center text-sm">
												<span class="text-xs font-weight-bold"> 07/11/2021 </span>
											</td>
											<td class="align-middle text-center text-sm">
												<a href="info" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
													Detil
												</a>
											</td>
											<td class="align-middle text-center text-sm">
												<a href="../pages/form-timbang.php" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
													Sampah
												</a>
											</td>
										</tr>
										<tr>
											...
											<td class="align-middle text-center text-sm">
												<span class="text-xs font-weight-bold"> Komplek Lippo Karawaci 1200, Jl. Boulevard Diponegoro, Bencongan, Kec. Klp. Dua, Tangerang, Banten </span>
											</td>
											<td class="align-middle text-center text-sm">
