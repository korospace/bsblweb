  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
      <div class="container-fluid py-1">
        <nav aria-label="breadcrumb">
          <h6 class="text-white font-weight-bolder ms-2 mt-4">Profile</h6>
        </nav>
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4"
        style="background-image: url('assets/images/curved-images/curved0.jpg'); background-position-y: 50%;">
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="assets/images/bruce-mars.jpg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
            ...
            <div class="col-xl-6 mb-xl-0 mb-4">
              <div class="card bg-transparent shadow-xl">
                <div class="overflow-hidden position-relative border-radius-xl"
                  style="background-image: url('assets/images/curved-images/curved14.jpg');">
                  ...
                  <div class="card-body position-relative z-index-1 p-3">
                    ...
                    <div class="d-flex">
                      ...
                      <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                        <img class="w-60 mt-2" src="assets/images/logos/banksampah-logo.png" alt="logo">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mt-md-0 mt-4">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      ...
                      <span class="text-xs">Tabungan Emas</span>
                      <hr class="horizontal dark my-3">
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-md-0 mb-4">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <!-- <img class="w-10 me-3 mb-0" src="assets/images/logos/mastercard.png" alt="logo"> -->
                        <h6 class="mb-0">RT :&nbsp;&nbsp;&nbsp;06&nbsp;&nbsp;&nbsp;</h6>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <!-- <img class="w-10 me-3 mb-0" src="assets/images/logos/visa.png" alt="logo"> -->
                        <h6 class="mb-0">RW :&nbsp;&nbsp;&nbsp;02&nbsp;&nbsp;&nbsp;</h6>
                      </div>
                    </div>
                  </div>
                </div>
