        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link <?= ($title=='Admin | list nasabah') ? 'active' : ''?>" href="<?= base_url('admin/listnasabah');?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <img src="https://img.icons8.com/pastel-glyph/64/000000/groups--v4.png" width="13px" height="13px" style="opacity: 0.6;"/>
                    </div>
            ...
            <li class="nav-item mt-2">
                <a class="nav-link <?= ($title=='Admin | profile') ? 'active' : ''?>" href="<?= base_url('admin/profile');?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="https://img.icons8.com/material-outlined/24/000000/security-pass.png" width="15px" height="15px" style="opacity: 0.6;"/>
                    </div>
