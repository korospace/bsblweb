...
const doValidate = (form) => {
    ...
    // alamat validation
    if ($('#formAddEditAdmin #alamat').val() == '') {
        $('#formAddEditAdmin #alamat').addClass('is-invalid');
        $('#formAddEditAdmin #alamat-error').html('*alamat harus di isi');
        status = false;
    }
    else if ($('#formAddEditAdmin #alamat').val().length > 255) {
        $('#formAddEditAdmin #alamat').addClass('is-invalid');
        $('#formAddEditAdmin #alamat-error').html('*maksimal 255 huruf');
        status = false;
    }
    // notelp validation
    if ($('#formAddEditAdmin #notelp').val() == '') {
        $('#formAddEditAdmin #notelp').addClass('is-invalid');
        $('#formAddEditAdmin #notelp-error').html('*no.telp harus di isi');
        status = false;
    }
    else if ($('#formAddEditAdmin #notelp').val().length > 14) {
        $('#formAddEditAdmin #notelp').addClass('is-invalid');
        $('#formAddEditAdmin #notelp-error').html('*maksimal 14 huruf');
        status = false;
    }
    else if (!/^\d+$/.test($('#formAddEditAdmin #notelp').val())) {
        $('#formAddEditAdmin #notelp').addClass('is-invalid');
